...
class NetworkLocationCheckStep extends CheckStep {
    ...
    public String getSolution() {
        return "Please activate network-based geolocation in Settings->Location. Since KitKat, you need to select any mode but \"device only\", on older Android version this setting is called \"W